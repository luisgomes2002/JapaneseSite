      ...
      <div className="background">
        <div className="config-text">
          ...
          <div className="center-items">
            ...
            <div className="grid-img">
              ...
              <div style={{ padding: "40px" }}>
                <h3 style={{ textAlign: "left" }}>
                  A prova é dividida em cinco níveis de proficiência, sendo o N5
                  o mais básico e o N1 o mais avançado. Para aqueles
                  interessados em aprender japonês para visitar o Japão, ter um
                  nível N5 ou N4 já proporciona uma experiência mais
                  confortável, permitindo realizar atividades simples, como ir a
                  restaurantes, fazer check-in em hotéis e outras tarefas
                  cotidianas. No entanto, se o objetivo for ter conversações com
                  nativos ou compreender a cultura japonesa em um nível mais
                  profundo, é recomendado ter, pelo menos, um nível equivalente
                  ao N3. Considera-se que qualquer pessoa com o nível N3 já seja
                  um bom falante de japonês, e alguns professores acreditam que
                  esses indivíduos estão aptos a ensinar o idioma, uma vez que
                  possuem uma sólida base na língua.
                </h3>
              </div>
            </div>
            <div className="jlpt-about">
              <h3 className="mb-5">
                ...
                saber que a maioria das empresas exige um nível mínimo
                comprovado de N2, exceto algumas empresas de TI que, às vezes,
                priorizam um bom domínio da língua inglesa. No entanto, vamos
                ser realistas: se você deseja construir uma vida em outro país,
                é essencial aprender o idioma por seu próprio benefício. Isso
                facilitará a resolução de questões burocráticas e permitirá que
                você compre alimentos em uma loja de conveniência (konbini) sem
                depender de ninguém.
              </h3>
              <h1>Pontuação</h1>
              <h3>
          ...
          <div className="table-jlpt">
                ...
                <tbody>
                  <tr>
                    ...
                    <td colSpan={2}>
                      ...
                      <b>
                        {" "}
                        0 a 120 pontos / nota de corte de 38 pontos <br /> 0 a
                        60 pontos / nota de corte de 19 pontos
                      </b>
                    </td>
                    <td>
            ...
            <h3>
              Todos os participantes do exame receberão o comunicado de
              aprovação ou reprovação em um prazo de um a dois meses após a
              realização da prova. Aqueles que forem aprovados receberão um
              certificado diretamente em suas residências. É importante
              ressaltar que a entrega do certificado pode levar mais de um mês.
            </h3>
          </div>
          <div>
            <div className="jlptlist-content">
              ...
              <h3>
                ...
                continente que conta com o maior número de locais de aplicação.
                Em cada país, há um preço específico para a inscrição no exame.
                Para consultar a lista de locais de realização da prova, você
                pode acessar o seguinte link{" "}
                <Link
            ...
            <div className="grid-card ">
              ...
              <div className="tabs-config">
                <h2>Localidades</h2>
                <p>
                  No Brasil, a prova do JPLT é realizada em um número limitado
                  de cidades. Algumas dessas cidades oferecem a prova uma vez
                  por ano, enquanto outras a disponibilizam duas vezes ao longo
                  do ano.
                </p>
                <p></p>
                <li>
                  São Paulo / Rio de Janeiro / Porto Alegre / Brasília : 2
                  Provas
                </li>
                <li>
                  Londrina / Belém / Salvador / Curitiba / Manaus : 1 Prova
                </li>
              </div>
            </div>
            <div className="link-consulado">
              <h3>
                Para saber qual é o consulado da sua região acesse o link
                abaixo.
              </h3>
              <Link
            ...
            <div className="jlptlist-content">
              <h1>Vídeos</h1>
              <h3>
                Amplie seu conhecimento sobre o JLPT assistindo aos vídeos
                abaixo.
              </h3>
            </div>
          </div>
